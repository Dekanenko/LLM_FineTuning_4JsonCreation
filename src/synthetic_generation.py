...
async def _text_generation(
    ...
    llm = ChatOpenAI(model=text_gen_model, temperature=text_gen_temperature, max_tokens=4096)
...
async def _json_generation(
    ...
    llm = ChatOpenAI(model=json_gen_model, temperature=json_gen_temperature, max_tokens=4096)
